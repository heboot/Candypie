package com.heboot.faceunity_unit.fulivedemo.renderer;
...
import com.heboot.faceunity_unit.fulivedemo.utils.CameraUtils;
import com.heboot.faceunity_unit.fulivedemo.utils.FPSUtil;
...
public class CameraRenderer implements Camera.PreviewCallback, GLSurfaceView.Renderer {
    ...
    public CameraRenderer(Activity activity, GLSurfaceView GLSurfaceView, OnRendererStatusListener onCameraRendererStatusListener) {
        ...
        mGLSurfaceView.setEGLContextFactory(new MyContextFactory(this));
    ...
    public static class MyContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public MyContextFactory(CameraRenderer renderer) {
    ...
    public EGLContext getmEGLCurrentContext() {
        return mEGLCurrentContext;
    }
}
