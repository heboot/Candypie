...
import com.heboot.faceunity_unit.fulivedemo.ui.RecordBtn;
import com.heboot.faceunity_unit.fulivedemo.utils.BitmapUtil;
import com.heboot.faceunity_unit.fulivedemo.utils.NotchInScreenUtil;
...
//    protected ImageView mSelectDataBtn;
    ...
    //自己添加的view
    protected TextView normal, gaoji, basic;
...
//        mGLSurfaceView.setRenderMode(GLSurfaceView.RENDERMODE_WHEN_DIRTY);
        ...
        normal = (TextView) findViewById(R.id.tv_normal);
        gaoji = (TextView) findViewById(R.id.tv_gaoji);
        basic = (TextView) findViewById(R.id.tv_basic);
