...
public class UIKitOptions {
    ...
    public int messageLeftGiftBackground = R.drawable.nim_message_item_left_gift_selector;
    ...
    public int messageRightGiftBackground = R.drawable.nim_message_item_right_gift_selector;
