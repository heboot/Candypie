...
public class NimUIKit {
    ...
    public static void startP2PSession(Context context, String account, String hideBottom, String hideAgain, String price, int is_im_chat, int isBlack, User user, User selfUser) {
        NimUIKitImpl.startP2PSession(context, account, !StringUtils.isEmpty(hideBottom), !StringUtils.isEmpty(hideAgain), price, is_im_chat, isBlack, user, selfUser);
    }
