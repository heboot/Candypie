...
public final class NimUIKitImpl {
    ...
    public static void startP2PSession(Context context, String account, boolean hideBottom, boolean hideAgain, String price, int isImchat, int isBlack, User user, User selfUser) {
        P2PMessageActivity.start(context, account, commonP2PSessionCustomization, null, hideBottom, hideAgain, price, isImchat, isBlack, user, selfUser);
    }
