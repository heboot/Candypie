        ...
        switch (recent.getMsgType()) {
            ...
            case custom:
                try {
                    ...
                    if (customAttachment.getType().equals(MessageType.MESSAGE_TYPE_ORDER)) {
                        return "[订单消息]";
                    } else if (customAttachment.getType().equals(MessageType.MESSAGE_TYPE_SYSTEM_MSG)) {
                        return customAttachment.getData().getMsg();
                    }else if (customAttachment.getType().equals(MessageType.MESSAGE_TYPE_GIFT_MSG)) {
                        return customAttachment.getData().getMsg();
                    }
                    return "系统通知";
                } catch (Exception e) {
