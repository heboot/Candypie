...
//            builder = Glide.with(getContext().getApplicationContext()).asGif().load(new File(path));
            Glide.with(getContext().getApplicationContext()).load(new File(path)).asGif();
        } else {
...
//                    .load(new File(path))
            ...
            Glide.with(getContext().getApplicationContext())
                    .load(new File(path)).asBitmap().override(width, height)
                    .fitCenter()
                    .placeholder(R.drawable.nim_image_default)
                    .error(R.drawable.nim_image_default).into(this);
        }
//        builder.into(this);
    }
