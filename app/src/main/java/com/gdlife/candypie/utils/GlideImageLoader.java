...
public class GlideImageLoader extends ImageLoader {
    ...
    public ImageView createImageView(Context context) {
        ...
        qmuiRadiusImageView.setCornerRadius(QMUIDisplayHelper.dp2px(context, 44));
//        qmuiRadiusImageView.setScaleType(ImageView.ScaleType.CENTER);
        qmuiRadiusImageView.setCircle(false);
        qmuiRadiusImageView.setLayoutParams(new ViewGroup.LayoutParams(QMUIDisplayHelper.dp2px(context, 383), QMUIDisplayHelper.dp2px(context, 88)));
