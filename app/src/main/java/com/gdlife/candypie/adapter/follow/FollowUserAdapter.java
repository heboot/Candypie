package com.gdlife.candypie.adapter.follow;
...
import com.gdlife.candypie.databinding.LayoutFollowItemBinding;
...
public class FollowUserAdapter extends BaseQuickAdapter<User, BaseViewHolder> {


    private String rank_title;


    public FollowUserAdapter(int layoutResId, List data, String rank_title) {
    ...
    protected void convert(BaseViewHolder helper, User s) {
        ...
        LayoutFollowItemBinding layoutRankItemBinding = DataBindingUtil.bind(helper.itemView);
...
//        }
        ...
        helper.setText(R.id.tv_value, s.getNums() + "");
