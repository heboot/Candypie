...
public class IndexUserWhite3ItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public IndexUserWhite3ItemDecoration(int spanCount, int spacing, boolean includeEdge) {
