...
public class WheelView22 extends ScrollView {
    public static final String TAG = WheelView22.class.getSimpleName();
...
//    private ScrollView scrollView;
    ...
    public WheelView22(Context context) {
        super(context);
        init(context);
    }

    public WheelView22(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public WheelView22(Context context, AttributeSet attrs, int defStyle) {
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
                    if (remainder == 0) {
                        ...
                        if (remainder > itemHeight / 2) {
                            WheelView22.this.post(new Runnable() {
                                @Override
                                public void run() {
                                    WheelView22.this.smoothScrollTo(0, initialY - remainder + itemHeight);
                            ...
                            WheelView22.this.post(new Runnable() {
                                @Override
                                public void run() {
                                    WheelView22.this.smoothScrollTo(0, initialY - remainder);
                                    selectedIndex = divided + offset;
                                    onSeletedCallBack();
                                }
                            });
                    ...
                    initialY = getScrollY();
                    WheelView22.this.postDelayed(scrollerTask, newCheck);
                }
            }
        };
    ...
    private TextView createView(String item) {
        ...
        tv.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 22);//16
        tv.setText(item);
...
//    }
    ...
    public void setSeletion(int position) {
        ...
        this.post(new Runnable() {
            @Override
            public void run() {
                WheelView22.this.smoothScrollTo(0, p * itemHeight);
            }
        });
